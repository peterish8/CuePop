  ...
  ({ className, sideOffset = 6, ...props }, ref) => (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "z-50 rounded-lg border border-[var(--color-border-strong)] bg-[var(--color-surface-elevated)] px-2.5 py-1.5 text-xs text-[var(--color-foreground)] shadow-[var(--shadow-md)]",
          className,
        )}
        {...props}
      />
